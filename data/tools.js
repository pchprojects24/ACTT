...
ddx: function(main) {
  ...
  const symptoms = ['Agitation','Altered LOC','Hypotension','Tachycardia','Bradycardia','Hypoxia','Fever','Hypothermia','Seizure','Pupil Asymmetry','Widened Pulse Pressure','JVD','Absent Breath Sounds','Tachypnea','Decreased Urine Output','Peripheral Edema','Cool Extremities','Chest Pain','Dyspnea','Vomiting','Facial/Neck Swelling','Burns','Bleeding'];
  symptoms.forEach(s => {
...
function generateDDx() {
  ...
  const conditions = [
    {name:'Tension Pneumothorax',priority:'high',symptoms:['Hypotension','Hypoxia','Tachycardia','Absent Breath Sounds','JVD','Dyspnea','Tachypnea'],desc:'Obstructive shock from pressure. Clinical diagnosis \u2014 do not delay decompression for imaging.',links:[{title:'Chest Decompression Algorithm',path:'#/algorithms/chest-decompression'},{title:'Needle Thoracostomy',path:'#/procedures/needle-thoracostomy'}]},
    {name:'Traumatic Brain Injury',priority:'high',symptoms:['Altered LOC','Pupil Asymmetry','Agitation','Seizure','Widened Pulse Pressure','Bradycardia','Vomiting'],desc:'Protect airway if GCS \u2264 8. Maintain SBP > 110 mmHg. Avoid hypoxia and hypotension.',links:[{title:'TBI Algorithm',path:'#/algorithms/tbi-management'},{title:'TBI Thresholds',path:'#/thresholds/neurologic-tbi'}]},
    {name:'Hemorrhagic Shock',priority:'high',symptoms:['Hypotension','Tachycardia','Cool Extremities','Altered LOC','Decreased Urine Output','Bleeding'],desc:'Volume resuscitation priority. Consider blood products. Identify and control source.',links:[{title:'Shock Management',path:'#/domains/domain-2'},{title:'Resuscitation Pitfalls',path:'#/pitfalls/circulation-errors'}]},
    {name:'Septic Shock',priority:'high',symptoms:['Hypotension','Tachycardia','Fever','Altered LOC','Decreased Urine Output','Tachypnea'],desc:'Early antibiotics within 1 hour. Fluid resuscitation then vasopressors. Source control.',links:[{title:'Sepsis Algorithm',path:'#/algorithms/sepsis'},{title:'Antibiotic Reference',path:'#/medications/antibiotics'}]},
    {name:'Cardiac Tamponade',priority:'high',symptoms:['Hypotension','JVD','Tachycardia','Dyspnea','Cool Extremities'],desc:'Beck triad: hypotension, JVD, muffled heart sounds. Consider pericardiocentesis.',links:[{title:'Pericardiocentesis',path:'#/procedures/pericardiocentesis'}]},
    {name:'Impending Cerebral Herniation',priority:'high',symptoms:['Altered LOC','Pupil Asymmetry','Widened Pulse Pressure','Bradycardia','Vomiting'],desc:'Cushing triad indicates brainstem compression. Immediate neuroprotection required.',links:[{title:'TBI Algorithm',path:'#/algorithms/tbi-management'},{title:'ICP Medications',path:'#/medications/icp-meds'}]},
    {name:'STEMI',priority:'high',symptoms:['Chest Pain','Hypotension','Tachycardia','Dyspnea'],desc:'12-lead ECG. If STEMI confirmed and PCI >90 min, consider fibrinolysis.',links:[{title:'STEMI Algorithm',path:'#/algorithms/stemi'},{title:'Tenecteplase Reference',path:'#/medications/fibrinolytics'}]},
    {name:'Anaphylaxis',priority:'high',symptoms:['Hypotension','Tachycardia','Dyspnea','Facial/Neck Swelling','Tachypnea'],desc:'Epinephrine 0.3\u20130.5 mg IM immediately. Repeat q5\u201315 min as needed.',links:[{title:'Epinephrine Reference',path:'#/medications/vasopressors'}]},
    {name:'Inhalation Injury / Airway Burn',priority:'high',symptoms:['Dyspnea','Facial/Neck Swelling','Burns','Hypoxia','Tachypnea'],desc:'Early airway control before progressive edema makes intubation impossible.',links:[{title:'Burn Algorithm',path:'#/algorithms/burn-resuscitation'},{title:'Airway Procedures',path:'#/procedures/rsi'}]},
    {name:'Severe Hypothermia',priority:'high',symptoms:['Hypothermia','Altered LOC','Bradycardia'],desc:'Handle gently. Active rewarming. Modified arrest protocols for stage IV.',links:[{title:'Hypothermia Algorithm',path:'#/algorithms/hypothermia'},{title:'Hypothermia Staging',path:'#/thresholds/hypothermia-staging'}]},
    {name:'Status Epilepticus',priority:'high',symptoms:['Seizure','Altered LOC','Agitation','Tachycardia'],desc:'Midazolam 5 mg IV/IM q5min. Protect airway. Load levetiracetam for maintenance.',links:[{title:'Seizure Medications',path:'#/medications/seizure-meds'}]},
    {name:'Hypoglycemia',priority:'high',symptoms:['Altered LOC','Agitation','Seizure','Tachycardia','Cool Extremities'],desc:'Check glucose when feasible. D50W or oral glucose if conscious.',links:[{title:'Combative Patient Algorithm',path:'#/algorithms/combative-patient'}]},
    {name:'Opioid Overdose',priority:'high',symptoms:['Altered LOC','Hypotension','Hypoxia','Bradycardia'],desc:'Naloxone 0.4\u20132 mg IV/IM/IN. Titrate to respiratory effort. Short half-life \u2014 may need repeat dosing.',links:[{title:'Naloxone Reference',path:'#/medications/reversal-agents'}]},
    ...
    {name:'Drug-Induced Hypotension',priority:'moderate',symptoms:['Hypotension','Tachycardia','Altered LOC'],desc:'Review recent medications \u2014 induction agents, sedatives, and vasodilators can compound hypotension.',links:[{title:'Medication Errors',path:'#/pitfalls/medication-errors'}]},
