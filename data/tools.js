...
function generateDDx() {
  ...
  const conditions = [
    ...
    {name:'Acute Ischemic Stroke',priority:'high',symptoms:['Focal Neurologic Deficit','Confusion','Unresponsive','Pupil Asymmetry'],desc:'Sudden onset focal deficit. Note time of onset. Protect airway if declining. Consider fibrinolytic eligibility if within treatment window.',links:[{title:'TBI Algorithm',path:'#/algorithms/tbi-management'}]},
