...
function generateDDx() {
  ...
  const conditions = [
    ...
    {name:'Hemorrhagic Shock',priority:'high',symptoms:['Hypotension','Tachycardia','Cool Extremities','Confusion','Unresponsive','Decreased Urine Output','External Hemorrhage','Signs of Internal Bleeding','Diaphoresis'],desc:'Volume resuscitation priority. Consider blood products. Identify and control source.',links:[{title:'Shock Management',path:'#/domains/domain-2-hemodynamics'},{title:'Resuscitation Pitfalls',path:'#/pitfalls/circulation-errors'}]},
    ...
    {name:'Status Epilepticus',priority:'high',symptoms:['Seizure','Unresponsive','Confusion','Agitation','Tachycardia'],desc:'Midazolam 5 mg IV/IM q5min. Protect airway. Load levetiracetam for maintenance.',links:[{title:'Seizure Algorithm',path:'#/algorithms/seizure-management'},{title:'Seizure Medications',path:'#/medications/seizure-meds'}]},
